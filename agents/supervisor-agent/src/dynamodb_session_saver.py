...
# Example usage and setup code
def create_dynamodb_table(table_name: str, region_name: str = "us-east-1"):
    """
    Create a DynamoDB table for checkpoint storage.
...
# Example: Using the DynamoDB checkpointer with LangGraph
if __name__ == "__main__":
    from langgraph.graph import StateGraph, END
    from typing import TypedDict, Annotated
    from operator import add

    # Define the state for your conversational agent
    ...
    # Option 1: Use Base64Serializer (default, most robust)
    checkpointer = DynamoDBSaver(
        table_name="langgraph-checkpoints", region_name="us-east-1"
    )

    # Option 2: Use JsonPlusSerializer (more readable in DynamoDB console)
    # from langgraph.checkpoint.serde.jsonplus import JsonPlusSerializer
    # checkpointer = DynamoDBSaver(
    ...
    # Example usage with both sync and async

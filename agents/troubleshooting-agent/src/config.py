...
class TroubleshootingConfig:
    ...
    def __init__(self):
        ...
        self.faq_knowledge_base_id = os.getenv("FAQ_KNOWLEDGE_BASE_ID", "FAQ_KB_DEFAULT")
        self.troubleshooting_knowledge_base_id = os.getenv("TROUBLESHOOTING_KNOWLEDGE_BASE_ID", "TROUBLESHOOT_KB_DEFAULT")
    ...
    def _get_default_claude_37_inference_profile(self) -> str:
        ...
        if region in claude_37_profiles:
            ...
            print(f"✅ Troubleshooting Agent: Using Claude 3.7 Sonnet cross-region inference profile for {region}: {profile_id}")
            ...
            print(f"⚠️  Troubleshooting Agent: Region {region} not configured for Claude 3.7 Sonnet cross-region profiles")

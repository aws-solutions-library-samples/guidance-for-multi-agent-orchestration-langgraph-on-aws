...
class PersonalizationConfig:
    ...
    def _get_default_claude_37_inference_profile(self) -> str:
        ...
        if region in claude_37_profiles:
            ...
            print(f"✅ Personalization Agent: Using Claude 3.7 Sonnet cross-region inference profile for {region}: {profile_id}")
            ...
            print(f"⚠️  Personalization Agent: Region {region} not configured for Claude 3.7 Sonnet cross-region profiles")

...
class ProductRecommendationConfig:
    ...
    def _get_default_claude_37_inference_profile(self) -> str:
        ...
        if region in claude_37_profiles:
            ...
            print(f"✅ Product Recommendation Agent: Using Claude 3.7 Sonnet cross-region inference profile for {region}: {profile_id}")
            ...
            print(f"⚠️  Product Recommendation Agent: Region {region} not configured for Claude 3.7 Sonnet cross-region profiles")

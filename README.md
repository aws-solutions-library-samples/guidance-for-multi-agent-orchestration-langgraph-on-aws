...
6. **AI/ML Services**: Amazon Bedrock with Claude 3.5 Sonnet for natural language processing and reasoning
...
- **Amazon Aurora**: Maximum 4 ACUs for Serverless v2 (configurable)

### Supported Regions

This Guidance supports the following AWS regions where Amazon Bedrock Claude 3.5 Sonnet is available:
...
3. Enable Amazon Bedrock model access:
   ...
   - Enable access for "Claude 3.5 Sonnet" model
